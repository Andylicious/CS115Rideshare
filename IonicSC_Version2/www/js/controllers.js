...
.controller('FriendsCtrl', function($scope, $state, $http,$stateParams, $timeout, ionicMaterialInk, ionicMaterialMotion,sharedProperties, sharedProf, sharedLinks) {
  ...
  $scope.course_func = function(vm){
    ...
    $scope.rtm_func = function(vm){

    sharedProf.set_course_prof(vm);
    $state.go('app.rtm');
  }
    // Set Header
...
.controller('RTMCtrl', function($scope,$stateParams,$http,$templateCache, $timeout, ionicMaterialMotion, ionicMaterialInk, sharedProf, sharedLinks) {
 // Set Header
    $scope.$parent.showHeader();
    $scope.$parent.clearFabs();
   // $scope.$parent.setHeaderFab('left');
