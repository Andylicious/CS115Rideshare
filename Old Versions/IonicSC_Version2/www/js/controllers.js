...
.service('sharedLinks',function(){
  ...
  return {
    ...
    set_course_link: function(value){
            course_link += value
            console.log("inside service = " + course_link)
    }
...
.controller('FriendsCtrl', function($scope, $state, $http,$stateParams, $timeout, ionicMaterialInk, sharedProf, ionicMaterialMotion,sharedProperties, sharedLinks) {
...
.service('sharedProf',function(){
  var course_prof = "";
  return {
    get_course_prof: function() {
      console.log("course_prof = " + course_prof)
            return course_prof;
        },
...
.controller('ProfileCtrl', function($scope, $stateParams,$http, $timeout, ionicMaterialMotion, ionicMaterialInk, sharedProf, sharedLinks) {
 // Set Header
...
// Animate list on this event
    ...
    //console.log("Course link = " + sharedLinks.get_course_link())
