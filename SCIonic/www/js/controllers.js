...
>>>>>>> Made bookmarks a little bit more robust, added a textbooks pane
  ...
  $scope.curr_quarter = sharedProperties.get_term_string();
    ...
    $scope.course_func = function(vm, vm_prof, vm_course){
      ...
      sharedLinks.set_books_link(vm_course.book);
...
<<<<<<< b1825cae3c2fc4ce4ef210346fcd14b7bcf26dc1
      var threshold;
<<<<<<< 697a5ca84c3f2fabb8ac16b28730d2a65fe2b6ce
...
.controller('AppCtrl', function ($ionicModal,$scope, sharedProperties, PisaService) {
  ...
  $scope.term_button = function(vm,classes){
   ...
   document.getElementById("termid").innerHTML = vm.term_string[term_index];
    ...
    sharedProperties.set_term_string(vm.term_string[term_index]);
...
.controller('bookmarksCtrl', function ($scope,$state, courseData, sharedLinks, sharedProf) {
...
.controller('bookViewCtrl', function ($sce,$scope, sharedLinks) {
  $scope.book_link = $sce.trustAsResourceUrl(sharedLinks.get_books_link());
  console.log("---->" + $scope.book_link)
